...
import resolution.formule.Bottom;
...
public class Atomic implements Formula {
	...
	public Formule toVincentFormula() {
		...
		if (predicate.getIdentifier().equals("bottom"))
			return new Bottom();
		else if (predicate.getIdentifier().equals("top"))
			return new Top();
		...
		return new Predicat(predicate.getIdentifier(), args);
	}
}
